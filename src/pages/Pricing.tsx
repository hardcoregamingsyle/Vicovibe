...
const plans = [
  {
    ...
    features: [
      ...
      "Build websites & Chrome extensions",
      "Access to base-level AI (Code + Writer)",
      "30 Full Project Checks",
      "3 Projects Maximum",
      "Community Support",
    ],
    tier: "free",
  ...
  },
  {
    ...
    features: [
      ...
      "Everything in Free",
      "Android & iOS app bundles (no mobile games)",
      "Smarter AI reasoning & planning",
      "60 Full Project Checks",
      "5 Projects Maximum",
    ],
    tier: "silver",
    popular: false,
  },
  {
    ...
    features: [
      ...
      "Enhanced AI accuracy & coding depth",
      "100 Full Project Checks",
      "8 Projects Maximum",
    ],
    tier: "gold",
    popular: true,
  },
  {
    ...
    features: [
      ...
      "Bot/automation builder (Discord, Telegram)",
      "Higher context AI with long memory",
      "250 Full Project Checks",
      "15 Projects Maximum",
    ],
    tier: "platinum",
    popular: false,
  },
  {
    ...
    features: [
      ...
      "Unlimited AI capability",
      "Complex multi-agent projects",
      "Dedicated compute priority",
      "Custom model tuning (coming soon)",
      "1000 Full Project Checks",
      "30 Projects Maximum",
    ],
    tier: "diamond",
    popular: false,
